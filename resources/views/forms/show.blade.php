                    ...
                    <h5 class="card-title">
                        ...
                        <div class="btn-toolbar float-md-right" role="toolbar">
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('forms.submissions.index', $form) }}" class="btn btn-primary float-md-right btn-sm">
                                    <i class="fa fa-th-list"></i> Submissions
                                </a> 
                                <a href="{{ route('forms.edit', $form) }}" class="btn btn-primary float-md-right btn-sm">
                                    <i class="fa fa-edit"></i> Edit
                                </a> 
                                <a href="{{ route('forms.create') }}" class="btn btn-primary float-md-right btn-sm">
