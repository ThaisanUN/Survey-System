                    ...
                    <h5 class="card-title">
                        ...
                        <div class="btn-toolbar float-md-right" role="toolbar">
                            <div class="btn-group" role="group" aria-label="Third group">
                                ...
                                <a href="{{ route('my-submissions.index') }}" class="btn btn-primary btn-sm">
                            ...
                            <tbody>
                                @foreach($forms as $form)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('forms.submissions.index', $form) }}" class="btn btn-primary btn-sm" title="View submissions for form '{{ $form->name }}'">
                                                <i class="fa fa-th-list"></i> Data
                                            </a>
                                            <a href="{{ route('forms.show', $form) }}" class="btn btn-primary btn-sm" title="Preview form '{{ $form->name }}'">
                                                <i class="fa fa-eye"></i> 
                                            </a> 
                                            <a href="{{ route('forms.edit', $form) }}" class="btn btn-primary btn-sm" title="Edit form">
