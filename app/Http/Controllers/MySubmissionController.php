...
class MySubmissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('my_submissions.index', compact('submissions', 'pageTitle'));
    }
    ...
    public function show($id)
    {
        ...
        return view('my_submissions.show', compact('submission', 'pageTitle', 'form_headers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('my_submissions.edit', compact('submission', 'pageTitle'));
    }
